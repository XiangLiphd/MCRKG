...
######################################################################
from transformers import BertTokenizer, RobertaForMaskedLM #BertModel #
...
model_name = '/home/lenovo/github/models/chinese-reberta-wwm'
TOKENIZER = BertTokenizer.from_pretrained(model_name)
LM_MODEL = RobertaForMaskedLMwithLoss.from_pretrained(model_name)
LM_MODEL.cuda()
