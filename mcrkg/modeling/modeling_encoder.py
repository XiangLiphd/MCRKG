...
class TextEncoder(nn.Module):
    ...
    def __init__(self, model_name,model_path, output_token_states=False, from_checkpoint=None, **kwargs):
        super().__init__()
        ...
        if self.model_type in ('lstm',):
            ...
            self.module = model_class.from_pretrained(model_path, output_hidden_states=True)
